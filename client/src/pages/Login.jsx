...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) { // #2 — was checking < 6, now uses shared util checking >= 8
    ...
    try {
      ...
      // #31 — extract proper error message
      const errorMessage =
        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass p-8 sm:p-10 rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Forgot Password — #20: navigate to /forgot-password page */}
